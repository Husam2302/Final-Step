...
const SupervisedProjectsSection = ({
  ...
  const ProjectCard = ({ project, type }) => (
    <div
      className={`p-4 rounded-xl  transition-all duration-300 cursor-pointer group relative overflow-hidden bg-var[--card-bg] ${
        type === "active"
    ...
    >
      ...
      <div className="flex justify-between items-start mb-3 relative z-10">
        ...
        <span
          className={`text-xs px-2 py-1 rounded-full ml-2 transition-all duration-300 ${
            type === "active"
          ...
          {tabs.map((tab) => {
            ...
            return (
              ...
              >
                ...
                {tab.label}
                <span
                  className={`text-xs px-2 py-1 rounded-full mr-2 transition-colors duration-200 ${
                    activeTab === tab.id
